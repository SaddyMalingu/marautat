...
import { FAQ_CONTENT, generateFAQSchema, SITE_URL } from '../utils/aiJobsSEO.js';
...
router.get('/ai-jobs/guides/:slug', async (req, res) => {
  try {
    ...
    res.send(renderGuidePage(guide, faqs, faqSchema, categories));
  } catch (err) {
...
function renderGuidePage(guide, faqs, faqSchema, categories) {
